...
class SettingsTest(unittest.TestCase):
    def setUp(self):
        ...
        self.initial = {'emergencyQQ': '123456789', 'bookingUrl': 'https://example.org/book'}
    ...
    def test_persistence_public_config_and_blank(self):
        value = {'emergencyQQ': '987654321', 'bookingUrl': 'https://example.org/new'}
        ...
        self.assertEqual(self.request(method='PUT', data={'emergencyQQ': '', 'bookingUrl': ''})[0], 200)
